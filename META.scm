...
(define architecture-decisions
  '((adr-001
     ...
     (status . "accepted")
     (date . "2025-12-15")
     (context . "A hyper-customizable dashboard for unified Git platform management. Starting with GitHub and GitLab integration, expanding to become the definitive interface for developers who demand control.")
...
(define development-practices
  '((code-style
     (languages . ("Ada" "CSS" "Dockerfile" "Elixir" "HTML" "Julia" "Just" "Nix" "ReScript" "Scheme"))
     (formatter . "gnatpp")
     (linter . "gnatcheck")
     (line-length . 100)
     (indent . "spaces")
