...
(define project-context
  '((name . "gitvisor")
    (tagline . "A hyper-customizable dashboard for unified Git platform management. Starting with GitHub and GitLab integration, expanding to become the definitive interface for developers who demand control.")
    (version . "0.1.0")
